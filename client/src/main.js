// Cambia esto en tu archivo main.js
import notion from './notion.mjs';

// a esto
import('./notion.mjs').then((notion) => {
  // Utiliza el módulo 'notion' aquí
  const databaseId = '39699e926a6e47d8a6617485d8b46e38';

  async function obtenerRegistros() {
    const response = await notion.default.databases.query({
